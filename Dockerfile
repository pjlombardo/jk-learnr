...
COPY lessons/logical-vectors /srv/shiny-server/logical-vectors
COPY lessons/filtering /srv/shiny-server/filtering
COPY lessons/23nMe /srv/shiny-server/23nMe
